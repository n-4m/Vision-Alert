...
import 'package:object_detection_app/widgets/aperture/aperture_leaf_painter.dart';
...
class _ApertureLeafState extends State<ApertureLeaf>
  ...
  void initState() {
    ...
    curvedAnimation = (widget.curvedAnimation ??
        CurvedAnimation(
            parent: animationController, curve: Curves.easeInOutBack));

    _slide1 = widget.startOpened
        ? Tween(begin: const Offset(open1, 0.0), end: const Offset(0.0, 0.0))
            .animate(curvedAnimation)
        : Tween(begin: const Offset(0.0, 0.0), end: const Offset(open1, 0.0))
            .animate(curvedAnimation);
    _slide2 = widget.startOpened
        ? Tween(begin: const Offset(open2, open1), end: const Offset(0.0, 0.0))
            .animate(curvedAnimation)
        : Tween(begin: const Offset(0.0, 0.0), end: const Offset(open2, open1))
            .animate(curvedAnimation);
    ...
    _slide5 = widget.startOpened
        ? Tween(
                begin: const Offset(-open2, -open1),
                end: const Offset(0.0, 0.0))
            .animate(curvedAnimation)
        : Tween(
                begin: const Offset(0.0, 0.0),
                end: const Offset(-open2, -open1))
            .animate(curvedAnimation);
